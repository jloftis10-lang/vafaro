...
export function TripCheck() {
  ...
  return <div className="check-shell shell">
    ...
    <p className="privacy-note">Your answers are stored in this browser for this prototype and are never sold.</p>
  </div>;
}
